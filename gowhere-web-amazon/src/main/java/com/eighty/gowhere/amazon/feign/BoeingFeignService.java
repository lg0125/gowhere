...
@FeignClient("gowhere-airline-boeing")
public interface BoeingFeignService {

    @GetMapping("/boeing/airline/pms/product/entity/list")
    List<AirlineProductVo> entityList(@RequestParam Map<String, Object> params);

    @GetMapping("/boeing/airline/pms/product/entity/info/{productId}")
    AirlineProductVo entityInfo(@PathVariable Long productId);

    @PostMapping("/boeing/airline/pms/order/save")
